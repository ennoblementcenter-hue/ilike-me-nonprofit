...
const PROGRAMS = [
  {
    ...
    long:
      "A multi-week, pillar-based journey building identity, emotional literacy, and healthy boundaries through practice, journaling, and small-group facilitation.",
    img: "/images/ylp.png",
  },
  {
    slug: "bedside",
    ...
    long:
      "Bedside conversations and follow-up coaching that convert crisis into commitment, with safety planning and care navigation.",
  ...
  },
  {
    ...
    long:
      "Skills, scripts, and supports to recognize harm, restore dignity, and practice consent and self-respect.",
    img: "/images/ivp.png",
  },
  {
    slug: "lgbtq",
    ...
    long:
      "Identity-affirming spaces that build esteem, belonging, and protective factors for LGBTQ youth.",
  ...
  },
  {
    ...
    long:
      "Training and toolkits for educators and youth workers to model empathy, accountability, and nervous-system aware discipline.",
...
function Inquire() {
  const program =
    typeof window !== "undefined" ? getQueryFromHash().get("program") || "" : "";
...
const TESTIMONIALS = [
  {
    quote: "Students named their worth and repaired relationships.",
    name: "Assistant Principal",
    org: "Urban HS",
  },
  {
    quote: "The bedside intervention changed my son’s trajectory.",
    name: "Parent",
    org: "Children’s Hospital",
  },
  {
    quote: "Staff now share language for empathy and accountability.",
...
const PRODUCTS = [
  {
    id: "ilm-workbook",
    name: "I LIKE ME Workbook",
    price: 25,
    img: "/images/shop-ILMwrkbk.png",
    link: "https://buy.stripe.com/cNi9AS0Zg7Q28eK05I48000",
  },
  {
    id: "boop-book",
    name: "Born Out of Pain — Memoir",
    price: 20,
    img: "/images/shop-BOOP-book.png",
    link: "https://buy.stripe.com/aFa3cueQ63zM8eKf0C48001",
  },
  {
    id: "ilm-hat",
    name: "I LIKE ME Hat",
    price: 20,
    img: "/images/shop-blk-n-white-hat.png",
    link: "https://buy.stripe.com/bJebJ0fUa1rE2Uq7ya48005",
  },
  {
    id: "ilm-mug",
    name: "I LIKE ME Mug",
    price: 15,
    img: "/images/shop-ILMmug.png",
    link: "https://buy.stripe.com/dRmcN4eQ69YaamS3hU48004",
  },
  {
    id: "ilm-tee",
    name: "I LIKE ME T-Shirt",
    price: 15,
    img: "/images/shop-blk-tee.png",
    link: "https://buy.stripe.com/aFaeVcdM2c6i1QmdWy48002",
  },
  {
    id: "ilm-journal",
    name: "I LIKE ME Affirmational Journal",
    price: 12,
    img: "/images/shop-ILMJournal.png",
    link: "https://buy.stripe.com/00w9ASdM2c6ibqWg4G48003",
  },
];
        ...
        {PRODUCTS.map((p) => (
          <div key={p.id} className="rounded-2xl border bg-white overflow-hidden">
            <img
              ...
              className="h-48 w-full object-cover"
              onError={(e) => {
                e.currentTarget.src = "https://picsum.photos/seed/ilmshop/800/600";
              }}
            />
            <div className="p-5">
